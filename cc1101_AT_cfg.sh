...
AT+CC1101=1,1,0,868.326447,47.60,0,199.95,812.50,99.97,5,2,211,145,0,0,0,1,0,1,0,0,0,0,0,0,0\r
" >> $d
...
AT+WIFI_PASS=$WIFI_PASS\r
AT+WIFI_SSID=$WIFI_SSID\r
AT+CC1101=0,1,0,868.326447,47.60,0,199.95,812.50,99.97,5,2,211,145,0,0,0,1,0,1,0,0,0,0,0,0,0\r
" >> $d
